...
crbmCompute: matrix.h utils.h crbm.h crbmCompute.o Makefile utils.h
	nvcc --gpu-architecture=sm_35 -o crbmCompute -O3 -D CUDA -lcuda -lcublas -lcurand -lcudart crbmCompute.o -g
